---
name: agents-sdk
description: Build or review Cloudflare Agents SDK applications on Workers. Use when Cloudflare Agents, the agents package on Workers, or its Agent class is explicitly involved. Do not use for generic AI agents, chat apps, scheduled tasks, or browser automation on other platforms.
---

# Cloudflare Agents SDK

Apply only after confirming this Cloudflare product is the requested or existing platform. A generic capability match is insufficient.
