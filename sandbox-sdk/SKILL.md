---
name: sandbox-sdk
description: Build or review Cloudflare Sandbox SDK integrations using @cloudflare/sandbox and Workers. Use when that SDK is requested or already present. Do not use for Firecracker, Docker, generic sandboxes, CI systems, or untrusted-code execution on other platforms.
---
